...
def smallsetrun(numbervalue, colname, exportfilepath): 
    from datetime import datetime
    start_time = datetime.now()
    numbervalue = int(numbervalue)
    texts_col = data[colname][:numbervalue]
    resultsample = predict(texts_col)
